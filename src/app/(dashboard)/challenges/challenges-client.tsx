...
interface ChallengesClientProps {
  workshopColdCallVideos: ChallengeVideo[]
...
export default function ChallengesClient({ workshopColdCallVideos, challenge10Videos, challenge9Videos, challenge8Videos, challenge6Videos }: ChallengesClientProps) {
  const [expandedChallenge, setExpandedChallenge] = useState<string | null>('workshop-cold-call')
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
        ...
        <section>
          <div className="space-y-6">
            {/* Workshop: Never Make Another Cold Call Again */}
            <Card className="card">
              <CardHeader>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-xl text-[var(--ink-inverse)]">
                        The Never Make Another Cold Call Again Workshop
                      </CardTitle>
                      <CardDescription className="text-[var(--ink-inverse)]/70 mt-1">
                        3-Day Live Workshop Replays
                      </CardDescription>
                    </div>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setExpandedChallenge(expandedChallenge === 'workshop-cold-call' ? null : 'workshop-cold-call')}
                  >
                    <Calendar className="h-4 w-4 mr-2" />
                    {expandedChallenge === 'workshop-cold-call' ? 'Hide' : 'View'} Replays
                  </Button>
                </div>
              </CardHeader>
              
              {expandedChallenge === 'workshop-cold-call' && (
                <CardContent>
                  {workshopColdCallVideos.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {workshopColdCallVideos.map((video) => (
                        <Link
                          key={video.id}
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-muted-foreground">Workshop videos will be available soon.</p>
                    </div>
                  )}
                </CardContent>
              )}
